                ...
                <div style="margin: 20px">
                    <form action="{{route('posts.update', $post->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Title" class="form-control" id="postTitle" aria-describedby="emailHelp" placeholder="Enter Post Title" value="{{old('Title', $post->Title)}}">
                            <small id="emailHelp" class="form-text text-muted">Post title</small>
                        </div>
                        <div class="form-group">
                            <label for="title">Post Text</label>
                            <input type="text" name="Post_text" class="form-control" id="postText" aria-describedby="emailHelp" placeholder="Enter Post Text" value="{{old('Post_text', $post->Post_text)}}">
